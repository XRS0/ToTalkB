...
const file_proto_notification_proto_rawDesc = "" +
	"\n" +
	"\x18proto/notification.proto\x12\n" +
	"gen_notify\"`\n" +
	...
	"\n" +
	"updated_at\x18\x04 \x01(\tR\tupdatedAt2\xe6\x01\n" +
	"\x13NotificationService\x12_\n" +
	"\x10SendNotification\x12#.gen_notify.SendNotificationRequest\x1a$.gen_notify.SendNotificationResponse\"\x00\x12n\n" +
	"\x15GetNotificationStatus\x12(.gen_notify.GetNotificationStatusRequest\x1a).gen_notify.GetNotificationStatusResponse\"\x00B\x0eZ\f./gen_notifyb\x06proto3"
...
var file_proto_notification_proto_goTypes = []any{
	(*SendNotificationRequest)(nil),       // 0: gen_notify.SendNotificationRequest
	(*SendNotificationResponse)(nil),      // 1: gen_notify.SendNotificationResponse
	(*GetNotificationStatusRequest)(nil),  // 2: gen_notify.GetNotificationStatusRequest
	(*GetNotificationStatusResponse)(nil), // 3: gen_notify.GetNotificationStatusResponse
}
var file_proto_notification_proto_depIdxs = []int32{
	0, // 0: gen_notify.NotificationService.SendNotification:input_type -> gen_notify.SendNotificationRequest
	2, // 1: gen_notify.NotificationService.GetNotificationStatus:input_type -> gen_notify.GetNotificationStatusRequest
	1, // 2: gen_notify.NotificationService.SendNotification:output_type -> gen_notify.SendNotificationResponse
	3, // 3: gen_notify.NotificationService.GetNotificationStatus:output_type -> gen_notify.GetNotificationStatusResponse
